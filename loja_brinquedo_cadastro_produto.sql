...
CREATE TABLE `cadastro_produto` (
  ...
  `nome_brinquedo` varchar(100) DEFAULT NULL,
  `descricao_brinquedo` varchar(255) DEFAULT NULL,
  `quantidade_brinquedo` int DEFAULT NULL,
  `preco_brinquedo` decimal(10,2) DEFAULT NULL,
